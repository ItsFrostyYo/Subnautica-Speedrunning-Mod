...
namespace Doorstop
{
    public static class Entrypoint
    {
        ...
        public static void Start()
        {
            ...
            SubnauticaSpeedrunningRanked.Bootstrap.Bootstrapper.Start();
        }
    }
}

namespace SubnauticaSpeedrunningRanked.Bootstrap
{
    internal static class Bootstrapper
    {
        public static void Start()
        {
            try
            {
                ...
                string rankedRoot = Directory.GetParent(bootstrapDirectory).FullName;
                string gameRoot = Directory.GetParent(rankedRoot).FullName;
                string logsDirectory = Path.Combine(rankedRoot, "Logs");
                ...
                string runtimePath = Path.Combine(
                    Path.Combine(rankedRoot, "Runtime"),
                ...
                Type runtimeEntryType = runtimeAssembly.GetType("SubnauticaSpeedrunningRanked.Runtime.RuntimeEntry", true);
