...
namespace SubnauticaSpeedrunningMod.Runtime
{
    internal static class RuntimeCrashReporter
    {
        ...
        {
            string crashDirectory = Path.Combine(Path.Combine(context.ModRoot, "Logs"), "CrashReports");
            ...
            builder.AppendLine("Subnautica Speedrunning Mod Runtime Crash Report");
            ...
            builder.AppendLine("ModRoot=" + context.ModRoot);
            ...
            builder.AppendLine("ModEnvironmentName=" + context.Config.ModEnvironmentName);
