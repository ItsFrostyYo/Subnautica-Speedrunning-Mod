...
{
    internal static class RankedOverlayRuntime
    {
        private const string OverlayRootName = "SubnauticaSpeedrunningRanked.PersistentOverlay";
        ...
        private static void RefreshTemplateStyle()
        {
            ...
            Text template = RankedOverlayUiUtility.FindTemplateText();
            if (template == null)
            {
                return;
            }
